...
if __name__ == '__main__':
    ur = UrTube()
    v1 = Video('Лучший актер 24 года', 200)
    v2 = Video('Для чего программы по фотошопу', 10, adult_mode=True)
    # Добавление видео
    ur.add(v1, v2)
    # Проверка поиска
...
ur.watch_video('Для чего программы по фотошопу')
ur.register('Argus_Maketikov', 'lolkekcheburek', 13)
ur.watch_video('Для чего программы по фотошопу')
ur.register('urban_pythonist', 'iScX4vIJClb9YQavjAgF', 25)
ur.watch_video('Для чего программы по фотошопу')
# Проверка входа в другой аккаунт
ur.register('Argus_Maketikov', 'F8098FM8fjm9jmi', 55)
